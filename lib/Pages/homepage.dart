...
class _HomepageState extends State<Homepage> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      stream: FirebaseFirestore.instance.collection("notes").where('isFav',isEqualTo: "no").where('id',isEqualTo: FirebaseAuth.instance.currentUser!.uid).snapshots(),
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              IconButton(onPressed: (){
                setState(() {
                  bool view=sharedPrefs.pref.getBool("isGrid")??false;
                  sharedPrefs.pref.setBool("isGrid", !view);
                });
              }, icon: sharedPrefs.pref.getBool("isGrid")??false?Icon(Icons.view_list):Icon(Icons.grid_view))
            ],
          ),
          ...
          Column(
            ...
            children: [
              ...
              ), child: Text("Add Note",style: TextStyle(color: Theme.of(context).colorScheme.tertiary,fontSize: 14)))
            ],
          ):
          Container(
                ...
                Align(
                    ...
                    child: Container(
                        ...
                        child: FloatingActionButton(
                          backgroundColor: Theme.of(context).appBarTheme.backgroundColor,
                          onPressed: (){
                            Navigator.of(context).push(MaterialPageRoute(builder: (context){return Notes();}));
                          },
